      ...
      <div>
        ...
        <ul className="flex flex-wrap gap-y-4 mt-8 flex-col items-center">
          {requests.map((eachRequest) => {
            ...
            const { firstName, lastName, avatar, _id } = fromUserId;
            eachRequest;
            return (
              <li
                className="flex items-center justify-between w-[40%]  p-4 rounded-md bg-white shadow-lg"
                key={requestId}
              >
                ...
                <div className="flex gap-2">
                  <button
                    className="bg-[#BF5CC9]  text-xs cursor-pointer hover:bg-[#9853a0] text-white px-4 py-1 rounded-full"
                    onClick={() => {
                  ...
                  <button
                    className="cursor-pointer text-xs bg-white border border-[#BF5CC9] text-[#BF5CC9] hover:bg-white/50 hover:border-[#9853a0] px-4 py-1 rounded-full"
                    onClick={() => {
